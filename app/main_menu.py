...
class EKYCApp:
    def __init__(self, root):
        ...
        ttk.Button(self.card_frame, text="4. Export All eKYC to CSV", command=self.export_to_csv).pack(pady=5)
    ...
    def show_data(self):
        ...
        columns = [
            ...
            "Aadhaar", "PAN", "Passport", "Nationality", "Date of Issue", "Date of Expiry", "Timestamp"
        ]
